...
-   Which columns are we interested in right now? soil_nitrogen, hairgrass_density
-   Which one is the independent variable and which is the dependent variable?
    -   independent: soil_nitrogen
    -   dependent: hairgrass_density
...
Because p \< 0.05 for the regression model, we reject the null hypothesis and conclude that there is a relationship between soil pH and hairgrass density.
