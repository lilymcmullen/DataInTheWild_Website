...
What do you notice about Population A that is different than Population B? Intrinsic growth rate negative
...
What has happened to this population? Crashed
...
Between Population A and Population B, which do you think is a better target population for fishing? Population B, `r` is positive
...
Lets look at the two logistic growth populations on the same plot:
