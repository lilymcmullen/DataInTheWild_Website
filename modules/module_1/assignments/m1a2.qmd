...
6.  Using what you know about subsetting data frames, write a line of code that returns the parka color for the team member in row 4. (Hint: count the columns!)
