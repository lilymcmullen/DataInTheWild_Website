...
3.  In your data folder, look for the data file called `aggregated_station_data.csv` and load it in using the `read_csv()` function. Save the data as an object called `weather`.
