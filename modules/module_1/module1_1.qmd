...
Let's all sign-up for [Posit Cloud!](https://posit.cloud/) We use Posit Cloud as our coding environment so everyone has access to R and RStudio thorugh a web browser.
