...
6.  Based on your own general knowledge, the information at the links above, and the additional information I've provided, list out the columns (only those in the .csv file) in your chosen dataset and give a brief description (just a phrase is fine) of what the data in each column represents. (3 points)

*Answer*:

7.  For each of the columns in your dataset, identify whether the data points they contain are categorical or numeric. Be sure your answers align with the information I've provided for you above. (3 points)
...
8.  First, determine which variable is the *dependent* variable in your dataset (there is usually only one, but there might be two). It must be numeric. (2 points)
...
11. Summarize your data by calculating at least 1 measure of central tendency and 1 measure of variability for your *dependent* variable using the `tidyverse` functions (you might need `na.rm = TRUE`!). (4 points)
...
12. Produce a histogram plot (just one, not multiple on the same plot) of the dependent variable. Write 1-2 sentences describing what information you can gather from the plot. (3 points)
...
13. Create a *multiple histogram* plot of your dependent variable and one other variable (this may or may not be your independent variable). Make sure we can see each histogram plot. (3 points)
...
16. Identify which plot(s) from Questions 15-17 match up with your research question. How do you know it matches up correctly (based on categorical vs. numeric variables)? (3 point)
...
18. Based on everything you know about your independent and dependent variables and the requirements for each of the statistical analyses we covered in the course, determine which statistical analysis you should perform to answer your question. In 1-2 sentences, explain why. (3 points)
