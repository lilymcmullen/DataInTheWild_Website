...
**Instructor Note:** Budget Collars LLC has 16 failures compared to just 4 for Collarium Inc. Budget Collars LLC is clearly the problem maker.
:::
...
::: instructor-only
**Instructor Note:** The plot shows two distinct clusters with almost no overlap. Collarium Inc. (teal) has higher battery life and lower signal distance. Budget Collars LLC (pink) has lower battery life and higher signal distance.

Budget Collars LLC appears to have designed their collars for longer signal range at the cost of battery life. The reason students should suspect is that transmitting a signal over a longer distance requires more power, which drains the battery faster.

This also sets up a key question for the next lesson. Is the difference in battery life between the two makers statistically meaningful, or could it be due to chance?
:::