...
12. Plot the seal data using a box-and-whisker plot. It doesn't need to be fancy (no need to fix axis labels and such) but be sure it has the following: Make sure your plot has the following:
    -   data points overlaying the boxes
    -   the points should be partially transparent and jittered
